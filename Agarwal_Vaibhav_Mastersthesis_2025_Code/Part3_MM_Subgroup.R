# Header Start =================================================================
# File Name: Part3_MM_Subgroup.R
# Purpose: Subgroup wise MM plots 
...
generate_mm_plot <- function(data_subset, subset_label, subtitle, 
                             show_legend = TRUE, show_y = TRUE, save_graph = FALSE) {
  
  mm_data <- mm(data_subset, choice ~ decision + agency + mistake + interest + transparency + accountability, id = ~ID)
  
  legend_position <- if (show_legend) 'right' else 'none'
  
  plot <- ggplot(mm_data, aes(x = estimate, y = level, color = feature)) +
    ...
    scale_x_continuous(limits = c(0.2, 0.8), breaks = seq(0.2, 0.8, by = 0.1)) +
    labs(
      x = 'Marginal Means',
  ...
  if (save_graph) {
    ...
    save_path <- file.path(base_path, "Figures", "Subgroup", "MM", file_name)
...
# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Gender_MM.png")
...
# Running MM function
young_plot <- generate_mm_plot(young_fi, "Young Adults", "Young Adults",
                               show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
older_plot <- generate_mm_plot(older_fi, "Older Adults", "Older Adults",
                               show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
middle_aged_plot <- generate_mm_plot(middle_aged_fi, "Middle-Aged", "Middle-Aged",
                                     show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_age <- (young_plot + older_plot + middle_aged_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Age',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Age_MM.png")
...
# Running MM function
no_college_plot <- generate_mm_plot(no_college_fi, "No College/University", "No College/University",
                                    show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
college_plot <- generate_mm_plot(college_fi, "College/University Education", "College/University Education",
                                 show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_edu <- (no_college_plot + college_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Education',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Education_MM.png")
...
# Running MM function
urban_plot <- generate_mm_plot(urban_fi, "Urban", "Urban",
                               show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
rural_plot <- generate_mm_plot(rural_fi, "Rural", "Rural",
                               show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_residence <- (urban_plot + rural_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Residence',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Residence_MM.png")
...
# Running MM function
retired_plot <- generate_mm_plot(retired_fi, "Retired", "Retired",
                                 show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
students_plot <- generate_mm_plot(students_fi, "Students", "Students",
                                  show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
employed_plot <- generate_mm_plot(employed_fi, "Employed", "Employed",
                                  show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
others_plot <- generate_mm_plot(others_fi, "Others", "Others",
                                show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_employment <- (retired_plot + students_plot + employed_plot + others_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Employment Status',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Employment_Status_MM.png")
...
# Running MM function
negative_plot <- generate_mm_plot(negative_fi, "Negative", "Negative",
                                  show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
positive_plot <- generate_mm_plot(positive_fi, "Positive", "Positive",
                                  show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_surveillance <- (negative_plot + positive_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Surveillance Attitude',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Surveillance_Attitude_MM.png")
...
# Running MM function
high_sat_plot <- generate_mm_plot(high_sat_fi, "High Satisfaction", "High Satisfaction",
                                  show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
medium_sat_plot <- generate_mm_plot(medium_sat_fi, "Medium Satisfaction", "Medium Satisfaction",
                                    show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
low_sat_plot <- generate_mm_plot(low_sat_fi, "Low Satisfaction", "Low Satisfaction",
                                 show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_govsat <- (high_sat_plot + medium_sat_plot + low_sat_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Government Satisfaction',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Government_Satisfaction_MM.png")
...
# Running MM function
appropriate_plot <- generate_mm_plot(appropriate_fi, "Appropriate", "Appropriate",
                                     show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
not_appropriate_plot <- generate_mm_plot(not_appropriate_fi, "Not Appropriate", "Not Appropriate",
                                         show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_techlaw <- (appropriate_plot + not_appropriate_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Modern Tech Law',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Modern_Tech_Law_MM.png")
...
# Running MM function
not_worried_sm_plot <- generate_mm_plot(not_worried_sm_fi, "Not worried at All", "Not worried at All",
                                        show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
little_worried_sm_plot <- generate_mm_plot(little_worried_sm_fi, "Little Worried", "Little Worried",
                                           show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
very_worried_sm_plot <- generate_mm_plot(very_worried_sm_fi, "Very Worried", "Very Worried",
                                         show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
somewhat_worried_sm_plot <- generate_mm_plot(somewhat_worried_sm_fi, "Somewhat Worried", "Somewhat Worried",
                                             show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_sm <- (not_worried_sm_plot + little_worried_sm_plot + very_worried_sm_plot + somewhat_worried_sm_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Worried About Social Media',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Worried_Social_Media_MM.png")
...
# Running MM function
not_worried_eserv_plot <- generate_mm_plot(not_worried_eserv_fi, "Not worried at All", "Not worried at All",
                                           show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
little_worried_eserv_plot <- generate_mm_plot(little_worried_eserv_fi, "Little Worried", "Little Worried",
                                              show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
very_worried_eserv_plot <- generate_mm_plot(very_worried_eserv_fi, "Very Worried", "Very Worried",
                                            show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
somewhat_worried_eserv_plot <- generate_mm_plot(somewhat_worried_eserv_fi, "Somewhat Worried", "Somewhat Worried",
                                                show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_eserv <- (not_worried_eserv_plot + little_worried_eserv_plot + very_worried_eserv_plot + somewhat_worried_eserv_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Worried About E-Services',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Worried_E_Services_MM.png")
...
# Running MM function
laggards_plot <- generate_mm_plot(laggards_fi, "Laggards", "Laggards",
                                  show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
majority_plot <- generate_mm_plot(majority_fi, "Majority", "Majority",
                                  show_legend = FALSE, show_y = FALSE, save_graph = FALSE)
early_adopters_plot <- generate_mm_plot(early_adopters_fi, "Early Adopters", "Early Adopters",
                                        show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_techadopt <- (laggards_plot + majority_plot + early_adopters_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Tech Adoption',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))
...
# Running MM function
task1_plot <- generate_mm_plot(task1, "1", "Task 1",
                                  show_legend = FALSE, show_y = TRUE, save_graph = FALSE)
task2_plot <- generate_mm_plot(task2, "2", "Task 2",
                                  show_legend = FALSE, show_y = FALSE, save_graph = FALSE)

# Combining Subgroup Plots
combined_plot_t1vst2 <- (task1_plot + task2_plot) +
  plot_annotation(
    title = 'Marginal Means Plot for Finland: Task 1 vs. Task 2',
    caption = '*Data collected from AGACA project under Daria Gritsenko'
  ) &
  theme(plot.title = element_text(color = "black", size = 16, face = "bold", hjust = 0.5))

# Saving the plots
save_path <- file.path(base_path, "Figures", "Subgroup", "MM", "Task1vsTask2.png")
ggsave(filename = save_path, plot = combined_plot_t1vst2, width = 12, height = 7, dpi = 300)
